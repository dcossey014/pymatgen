...
namei="Epsilon Task"
eps_fw = bint.BgwFirework(eps_inp, name=namei, complex=cmplx_bool, mpi_cmd=mpi_cmd)
...
sig_fw = bint.BgwFirework(sig_inp, name="Sigma Task", ppx=ppx, complex=cmplx_bool, mpi_cmd=mpi_cmd)
...
abs_fw = bint.BgwFirework(abs_inp, name="Absorption Task", complex=cmplx_bool,  mpi_cmd=mpi_cmd)

db_fw = Firework(BgwDB(config_file='bgw_db.yaml', insert_to_db=False), name="BGW DB Task")
