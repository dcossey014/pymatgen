...
from pymatgen.io.bgw.tools import gsphere
...
fftdum,number_bands=gsphere(s, screening_cutoff)
...
fftw_grid, dummy=gsphere(s, e_cut_mean_field)
...
qemft = bint.QeMeanFieldTask(structure=s, pseudo_dir=pseudo_dir,
        ...
        bandstructure_kpoint_path=True, num_kpoints_bandstructure=500)
