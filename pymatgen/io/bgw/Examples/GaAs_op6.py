...
eps_inp.number_bands = 60

eps_fw = BgwFirework(eps_inp, name="Epsilon Task", complex=cmplx_bool, mpi_cmd='mpiexec_mpt -n 72')
...
sig_fw = BgwFirework(sig_inp, name="Sigma Task", ppx=ppx, complex=cmplx_bool, mpi_cmd='mpiexec_mpt -n 72')
